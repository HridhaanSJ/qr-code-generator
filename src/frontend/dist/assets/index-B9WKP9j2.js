import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, C as React, q as React$1, R as ReactDOM } from "./index-DVsu3fCU.js";
/**
...
var ve = (n) => {
  ...
  }, [t.closeButton, et]), Tt = React$1.useMemo(() => t.duration || X || Wt, [t.duration, X]), gt = React$1.useRef(0), U = React$1.useRef(0), St = React$1.useRef(0), K = React$1.useRef(null), [Gt, Qt] = st.split("-"), Rt = React$1.useMemo(() => S.reduce((r2, m, c) => c >= dt ? r2 : r2 + m.height, 0), [S, dt]), Et = Ft(), qt = t.invert || e, ht = N === "loading";
  ...
  function Zt() {
    var r2, m, c;
    return P != null && P.loading ? React$1.createElement("div", { className: M(s == null ? void 0 : s.loader, (r2 = t == null ? void 0 : t.classNames) == null ? void 0 : r2.loader, "sonner-loader"), "data-visible": N === "loading" }, P.loading) : rt ? React$1.createElement("div", { className: M(s == null ? void 0 : s.loader, (m = t == null ? void 0 : t.classNames) == null ? void 0 : m.loader, "sonner-loader"), "data-visible": N === "loading" }, rt) : React$1.createElement(Yt, { className: M(s == null ? void 0 : s.loader, (c = t == null ? void 0 : t.classNames) == null ? void 0 : c.loader), visible: N === "loading" });
  }
  ...
  }, className: M(s == null ? void 0 : s.cancelButton, (At = t == null ? void 0 : t.classNames) == null ? void 0 : At.cancelButton) }, t.cancel.label) : null, reactExports.isValidElement(t.action) ? t.action : t.action && tt(t.action) ? React$1.createElement("button", { "data-button": true, "data-action": true, style: t.actionButtonStyle || l, onClick: (r2) => {
    var m, c;
