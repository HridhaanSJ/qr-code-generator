...
function ClaimAdminGate({ adminPrincipal }) {
  ...
  async function handleClaim() {
    try {
      ...
      ue.success("Admin role claimed successfully!");
    } catch {
      ue.error("Failed to claim admin. An admin may already be set.");
    }
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 flex items-center justify-center py-24", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "max-w-sm w-full text-center shadow-lg border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "pt-10 pb-10 flex flex-col items-center gap-5", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-14 h-14 rounded-full bg-destructive/10 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ShieldAlert, { className: "w-7 h-7 text-destructive" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-display font-bold text-foreground", children: "Not Authorized" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm mt-1", children: adminPrincipal ? "An admin is already set and your account doesn't have access." : "No admin has been set yet. Claim the admin role to get started." })
    ] }),
    !adminPrincipal && /* @__PURE__ */ jsxRuntimeExports.jsx(
      Button,
      {
        className: "w-full",
        onClick: handleClaim,
        ...
        children: claimAdmin.isPending ? "Claiming…" : "Claim Admin Role"
      }
    )
  ] }) }) });
}
function TickerPanel() {
  ...
  async function handleAdd() {
    ...
    try {
      ...
      setNewText("");
      ue.success("Ticker message added.");
    } catch {
      ue.error("Failed to add message.");
    }
  }
  function startEdit(m2) {
    setEditingId(m2.id);
    setEditText(m2.message);
  }
  async function handleSaveEdit(id) {
    ...
    try {
      ...
      setEditingId(null);
      ue.success("Message updated.");
    } catch {
      ue.error("Failed to update message.");
    }
  }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "border-border bg-card shadow-sm", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "space-y-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
              ...
              value: newText,
              onChange: (e3) => setNewText(e3.target.value.slice(0, MAX_TICKER_CHARS)),
              disabled: !canAdd,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center text-xs text-muted-foreground", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: !canAdd ? "Maximum 5 messages reached. Delete one to add another." : "Messages display randomly in the homepage ticker." }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "span",
              {
                className: newText.length >= MAX_TICKER_CHARS ? "text-destructive font-medium" : "",
                children: [
                  newText.length,
                  " / ",
                  MAX_TICKER_CHARS
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Button,
          {
            ...
            children: addMsg.isPending ? "Adding…" : "Add Message"
          }
        )
      ] })
    ] }),
    messages.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(MessageSquare, { className: "w-10 h-10 opacity-30" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm", children: "No ticker messages yet. Add one above." })
        ]
      }
    ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: messages.map((m2) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      Card,
      {
        className: "border-border bg-card shadow-sm",
        "data-ocid": `ticker-row-${m2.id}`,
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "py-3 px-4", children: editingId === m2.id ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
              value: editText,
              onChange: (e3) => setEditText(e3.target.value.slice(0, MAX_TICKER_CHARS)),
              autoFocus: true,
              "data-ocid": `ticker-edit-input-${m2.id}`
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                ...
                {
                  size: "sm",
                  onClick: () => handleSaveEdit(m2.id),
                  disabled: !editText.trim() || editText.length > MAX_TICKER_CHARS || updateMsg.isPending,
                  "data-ocid": `ticker-save-btn-${m2.id}`,
                  children: "Save"
                }
              )
            ] })
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "flex-1 min-w-0 text-sm text-foreground truncate", children: m2.message }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 shrink-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                ...
                onClick: () => startEdit(m2),
                "aria-label": "Edit message",
                "data-ocid": `ticker-edit-btn-${m2.id}`,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                ...
                onClick: () => handleDelete(m2.id),
                disabled: deleteMsg.isPending,
                "aria-label": "Delete message",
                "data-ocid": `ticker-delete-btn-${m2.id}`,
...
function CustomChartTooltip({ active, payload, label }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-lg px-3 py-2 shadow-md text-xs", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-display font-bold text-primary text-sm", children: [
      payload[0].value,
      " ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-normal text-foreground", children: "QR codes" })
    ] })
  ] });
}
function StatsPanel() {
  const { data: stats = [], isLoading } = useGetAdminStats();
  const total = stats.reduce((sum, d2) => sum + d2.count, 0);
  const peak = stats.reduce((max2, d2) => Math.max(max2, d2.count), 0);
  ...
  if (isLoading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 sm:grid-cols-3 gap-4", children: [1, 2, 3].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-20 w-full rounded-lg" }, i)) }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 sm:grid-cols-3 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-primary/10 rounded-xl px-5 py-4 border border-primary/20", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground font-medium uppercase tracking-wide", children: "Total (30 days)" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-3xl font-display font-bold text-primary mt-1", children: total.toLocaleString() }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: "QR codes generated" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card rounded-xl px-5 py-4 border border-border", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground font-medium uppercase tracking-wide", children: "Peak Day" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-3xl font-display font-bold text-foreground mt-1", children: peak.toLocaleString() }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: "highest single day" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card rounded-xl px-5 py-4 border border-border col-span-2 sm:col-span-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground font-medium uppercase tracking-wide", children: "Daily Average" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-3xl font-display font-bold text-foreground mt-1", children: stats.length > 0 ? Math.round(total / stats.length).toLocaleString() : 0 }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: "codes per day" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Card,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "bg-primary/5 border-b border-border pb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardTitle, { className: "text-base font-display font-semibold flex items-center gap-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", className: "ml-auto text-xs", children: "All Users" })
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "pt-6 pb-4 px-2 sm:px-4", children: stats.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              className: "flex flex-col items-center justify-center py-16 gap-3 text-muted-foreground",
              "data-ocid": "stats-empty-state",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(ChartNoAxesColumn, { className: "w-10 h-10 opacity-30" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm", children: "No activity data yet for the last 30 days." })
              ]
            }
            ...
            BarChart,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Tooltip,
                  {
                    content: /* @__PURE__ */ jsxRuntimeExports.jsx(CustomChartTooltip, {}),
...
function formatNanoTimestamp(nanos) {
...
function PaymentsPanel() {
  ...
  const totalE8s = payments.reduce((sum, p2) => sum + p2.amountE8s, 0n);
  if (isLoading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-20 w-full rounded-lg" }),
      [1, 2, 3].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-12 w-full rounded-lg" }, i))
    ] });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-primary/10 rounded-xl px-6 py-5 border border-primary/20 flex items-center gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 rounded-full bg-primary/20 flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CreditCard, { className: "w-6 h-6 text-primary" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground font-medium uppercase tracking-wide", children: "Total ICP Collected" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-3xl font-display font-bold text-primary mt-0.5", children: [
          formatIcp(totalE8s),
          " ICP"
        ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "border-border bg-card shadow-sm overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "bg-primary/5 border-b border-border pb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardTitle, { className: "text-base font-display font-semibold flex items-center gap-2", children: [
      ...
      payments.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
        CardContent,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm", children: "No payments yet." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-center max-w-xs", children: "When users unlock analytics with ICP, their payments will appear here." })
          ]
        }
      ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", "data-ocid": "payments-table", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "bg-primary/10 border-b border-border", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left px-4 py-3 font-display font-semibold text-primary text-xs uppercase tracking-wide", children: "User Principal" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left px-4 py-3 font-display font-semibold text-primary text-xs uppercase tracking-wide", children: "Date Paid" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-right px-4 py-3 font-display font-semibold text-primary text-xs uppercase tracking-wide", children: "ICP Amount" })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: payments.map((p2, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "tr",
          {
            className: idx % 2 === 0 ? "bg-card" : "bg-muted/30",
            "data-ocid": `payment-row-${idx + 1}`,
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 font-mono text-xs text-foreground", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { title: p2.userId, children: truncatePrincipal(p2.userId) }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 text-muted-foreground text-xs", children: formatNanoTimestamp(p2.timestamp) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "px-4 py-3 text-right", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-semibold text-primary text-sm", children: formatIcp(p2.amountE8s) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground ml-1", children: "ICP" })
              ] })
            ]
          },
          `${p2.userId}-${p2.timestamp}`
        )) })
      ] }) })
    ] })
  ] });
...
function AdminDashboard() {
  ...
  const totalQrCodes = stats.reduce((sum, d2) => sum + d2.count, 0);
  const totalIcpE8s = payments.reduce((sum, p2) => sum + p2.amountE8s, 0n);
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-4 flex-wrap", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3 flex-wrap", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-primary/10 rounded-lg px-4 py-2 text-center", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Ticker Msgs" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-primary/10 rounded-lg px-4 py-2 text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-2xl font-display font-bold text-primary", children: formatIcp(totalIcpE8s) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "ICP Collected" })
        ] })
      ] })
    ] }),
    adminPrincipal && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-xs text-muted-foreground bg-muted/40 border border-border rounded-lg px-3 py-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CircleAlert, { className: "w-4 h-4 shrink-0 text-primary" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-mono truncate", children: [
        "Admin: ",
        adminPrincipal
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { defaultValue: "stats", "data-ocid": "admin-tabs", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsList, { className: "bg-muted/60 border border-border w-full sm:w-auto", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          TabsTrigger,
          {
            value: "stats",
